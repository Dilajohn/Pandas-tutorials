...
reviews['index_backwards'] = range(len(reviews), 0, -1)  # Create a new column 'index_backwards' in the DataFrame and assign 
#it a range of values counting backwards from the length of the DataFrame to 1
